...
import lab.zhang.apollo.pojo.operator.comparator.NotEqualTo;
...
public class NotEqualToTest {
    ...
    public void test_calc() {
        assertFalse(target.calc(Lists.list(op0, op0), paramContext, exeConfig));
        ...
        assertTrue(target.calc(Lists.list(op0, op3), paramContext, exeConfig));
    }
