...
import lab.zhang.apollo.pojo.operators.comparators.NotEqualTo;
...
public class NotEqualToTest {
    ...
    public void test_calc() {
        assertFalse(target.calc(Lists.list(op0, op0), paramContext));
        assertTrue(target.calc(Lists.list(op0, op1), paramContext));
        assertFalse(target.calc(Lists.list(op0, op2), paramContext));
        assertTrue(target.calc(Lists.list(op0, op3), paramContext));
    }
