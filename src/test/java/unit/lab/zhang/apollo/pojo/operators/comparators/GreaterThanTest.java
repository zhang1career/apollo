...
public class GreaterThanTest {
    ...
    public void test_calc() {
        ...
        assertTrue(target.calc(Lists.list(op1, op0), paramContext));
        assertFalse(target.calc(Lists.list(op2, op3), paramContext));
        assertTrue(target.calc(Lists.list(op3, op2), paramContext));

        assertFalse(target.calc(Lists.list(op0, op2), paramContext));
        assertTrue(target.calc(Lists.list(op3, op1), paramContext));
    }
