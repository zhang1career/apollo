...
import lab.zhang.apollo.pojo.operators.comparators.GreaterThanOrEqualTo;
...
public class GreaterThanOrEqualToTest {
    private GreaterThanOrEqualTo target;
    ...
    @Before
    public void setUp() {
        target = GreaterThanOrEqualTo.of();
    ...
    public void test_calc() {
        ...
        assertTrue(target.calc(Lists.list(op1, op2), paramContext));
