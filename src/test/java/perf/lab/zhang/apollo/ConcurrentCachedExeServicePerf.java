...
//
//public class ConcurrentCachedExeServicePerf {
//    @Rule
//    public JUnitPerfRule perfTestRule = new JUnitPerfRule(new HtmlReportGenerator("doc/report/perf/concurrent-cached-executor.html"));
//
